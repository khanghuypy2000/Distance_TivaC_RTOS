...
#define LCD_RS_0 GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_0,0);
#define LCD_RS_1 GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_0,GPIO_PIN_0);

#define LCD_EN_0 GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_1,0);
#define LCD_EN_1 GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_1,GPIO_PIN_1);

#define LCD_DATA_4_0 GPIOPinWrite(GPIO_PORTB_BASE, GPIO_PIN_0,0);
#define LCD_DATA_4_1 GPIOPinWrite(GPIO_PORTB_BASE, GPIO_PIN_0,GPIO_PIN_0);

#define LCD_DATA_5_0 GPIOPinWrite(GPIO_PORTB_BASE, GPIO_PIN_1,0);
#define LCD_DATA_5_1 GPIOPinWrite(GPIO_PORTB_BASE, GPIO_PIN_1,GPIO_PIN_1);

#define LCD_DATA_6_0 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_4,0);
#define LCD_DATA_6_1 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_4,GPIO_PIN_4);

#define LCD_DATA_7_0 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_7,0);
#define LCD_DATA_7_1 GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_7,GPIO_PIN_7);
